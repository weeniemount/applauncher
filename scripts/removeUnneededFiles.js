...
exports.default = async function(context) {
    ...
    fs.readdir(mainDir, function(err, files) {
        ...
        files.forEach(file => {
            ...
            const filesToKeep = ['App Launcher.exe', 'app-launcher.exe', 'ffmpeg.dll', 'icudtl.dat', 'resources.pak', 'v8_context_snapshot.bin', 'resources', 'locales', 'chrome_100_percent.pak', 'chrome_200_percent.pak', 'swiftshader'];
            const filesToKeepLinux = ['app-launcher', 'App Launcher', 'chrome_crashpad_handler', 'chrome-sandbox', 'libffmpeg.so', 'icudtl.dat', 'resources.pak', 'v8_context_snapshot.bin', 'resources', 'locales', 'chrome_100_percent.pak', 'chrome_200_percent.pak', 'swiftshader', 'usr'];
